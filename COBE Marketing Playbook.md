...
- Defines audiences, messaging pillars, and channel roles so teams can align content with program goals and COBE resources.
- Provides ready-to-use cadences, specs, and approval flows for social, email, web, events, and partner outreach.
- Establishes intake, lead-time, and asset guidelines to streamline collaboration with COBE Marketing (cobe-info@boisestate.edu).
...
- Provide a repeatable system for programs to leverage COBE Marketing channels efficiently and consistently.
- Reduce duplication, clarify requirements, and capture best practices that already work for RHM/NP/+Business programs.
...
- **Faculty/Program leads**: Supply timely inputs (photos, quotes, event info) and review messaging for accuracy.
- **Leadership/partners**: Use for planning, budgeting, and oversight; assign owners for gaps.

### 1.3 COBE brand overview
- **Mission/positioning (RHM focus)**: Deliver industry-aligned hospitality education and training that converts students into workforce-ready leaders and offers flexible micro-credentials for employers.
...
- **Key value propositions**:
  - Career fairs and mixers that connect employers with COBE talent.
  - Flexible online/self-paced and in-person leadership trainings for frontline to management teams.
  - Paid, project-based RHM493 internships that produce measurable outcomes for host organizations.

### 1.4 Target audiences
- **Prospective undergraduates**: Seeking flexible credentials and career pathways; want clear value, community, and outcomes. COBE promises stackable certificates and industry exposure.
- **Prospective graduate students/continuing education**: Need leadership and management upskilling; COBE offers in-person facilitation tailored to supervisors/managers.
- **Current students**: Need advising on certificates, events, and internships; COBE provides news, social posts, and email updates with clear CTAs and deadlines.
- **Alumni**: Interested in professional development and networking; promote mixers, leadership modules, and partner trainings.
- **Employers/industry partners**: Need talent pipelines and training; COBE offers fairs, paid project-based interns, and free/paid training bundles.

### 1.5 Core messaging pillars
1. **Career-readiness and leadership** – COBE programs convert learning into measurable workplace impact through paid leadership projects and targeted training.
...
2. **Flexible learning formats** – Online self-paced modules plus in-person facilitation to meet frontline and management needs.
   - “Complete modules in under 60 minutes; pause and resume anytime.”
   - “Add one in-person leadership workshop to deepen skills.”
3. **Employer partnership and pipeline** – Career fairs, mixers, and bundled trainings connect employers to vetted talent and upskilling options.
...
4. **Accessible collaboration** – Clear submission rules, lead times, and approvals reduce friction for departments and student orgs.
...
- **Links & templates:**
  - [Social Media Calendar Template](Social%20Media%20Calendar%20Template.xlsx) – Excel template for weekly/monthly scheduling.
  - [Social Media Calendar Example](Social%20Media%20Calendar%20Example.xlsx) – Sample calendar to model structure and pacing.

### 2.2 LinkedIn
- **Role**: Professional storytelling, employer partnerships, alumni highlights, Online BBA community building.
...
- **Links & templates:**
  - Use the campaign brief template in [Section 3.2](#32-campaign-framework) for major employer campaigns.
...
- For web edits, specify exact text/URL to change; for events, include full description and registration link.

### 5.5 File and asset management
- Store assets in shared drive folders by campaign; include final graphics in required sizes.
- Name files with topic_start-end-date (e.g., “CareerFair_2025-10-01_1920x1080.jpg”).
- Maintain links to templates ([Section 7.6](#76-link-library)) and keep current versions dated.
...
- **Monthly**: Channel roll-up vs. goals; student newsletter summary.
...
### 7.1 Email templates
- **Event include request**: Send ASAP with event description, date/time, location, registration link, photo; subject “STUDENT ORG REQUEST.”
- **Certificate feature blurb examples**: Hospitality and Nonprofit certificate blurbs from newsletter draft.

### 7.2 Social media templates
- Use square (1080x1080) for grid; 1080x1920 for stories/reels; 1920x1080 for banners and MBEB screens.
- Include minimal text; outline edges for white backgrounds on MBEB screens.

### 7.3 Campaign brief template
- Use the table in [Section 3.2](#32-campaign-framework); duplicate for each campaign and store in a shared folder.

### 7.4 Content calendar template
- [Social Media Calendar Template](Social%20Media%20Calendar%20Template.xlsx) and [Social Media Calendar Example](Social%20Media%20Calendar%20Example.xlsx) for weekly/monthly planning.

### 7.5 Reporting templates
- Tables in [Section 6.3](#63-reporting-templates); copy into a shared doc or sheet per reporting period.

### 7.6 Link library
| Resource | Purpose | Link |
| --- | --- | --- |
| RHM Playbook Scope | Original objectives for COBE-aligned playbook | [RHM Playbook](RHM%20Playbook.docx) |
| RHM Program Overview | Messaging inputs for RHM fairs, trainings, internships | [2025–2026 RHM Overview](2025-2026%20RHM%20Overview.docx) |
| Promotion Requirements | Lead times, specs, contacts for student org/COBE promotions | [Promotion Resources](Promotion%20Resources.docx) |
| Kate Watson Marketing Notes | Channel ideas, asset sizes, newsletter cadence, accessibility requirements | [Kate Watson Marketing Notes](Kate%20Watson%20Marketing%20director%20notes.docx) |
| Social Media Calendar Template | Plan weekly/monthly posts | [Social Media Calendar Template](Social%20Media%20Calendar%20Template.xlsx) |
| Social Media Calendar Example | Completed example calendar | [Social Media Calendar Example](Social%20Media%20Calendar%20Example.xlsx) |
| RHM Marketing Budget 2025 | RHM marketing budget proposal (notes) | [RHM Marketing Budget 2025](RHM%20Marketing%20Budget%202025.xlsx) |
...
- Use Boise State brand standards for all graphics; MBEB screens already include logo (no extra logo needed).
